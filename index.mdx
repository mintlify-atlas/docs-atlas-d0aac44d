...
sidebarTitle: "Home"
description: "Axelar Core is the Cosmos SDK blockchain behind Axelar Network — enabling cross-chain transfers and message passing for EVM, IBC, and CosmWasm chains."
---
