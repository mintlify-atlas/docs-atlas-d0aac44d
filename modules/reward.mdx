...
sidebarTitle: "Reward"
description: "The Reward module distributes inflation-based rewards to validators for maintaining external chains and participating in key management, with configurable rates for each activity."
---
...
axelard tx reward refund-msg [msg-json] \
  --from <gov-key> \
  --chain-id axelar-dojo-1

# Update reward module parameters via governance
axelard tx reward update-params \
  --external-chain-voting-inflation-rate 0.05 \
  --key-mgmt-relative-inflation-rate 0.1 \
  --from <gov-key> \
  --chain-id axelar-dojo-1
```
