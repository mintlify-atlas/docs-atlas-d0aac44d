---
title: "Permission Module: Governance Key and Controller Roles"
sidebarTitle: "Permission"
description: "The Permission module manages Axelar's governance key — a threshold multisig that authorizes privileged operations — and a set of controller accounts with elevated network access."
---
...
The only supported privileged role is `ROLE_CHAIN_MANAGEMENT`, which grants permission to register chains, assets, and perform other administrative actions without requiring the full governance multisig signature.
