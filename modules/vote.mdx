---
title: "Vote Module: Quadratic Voting for Cross-Chain Events"
sidebarTitle: "Vote"
description: "The Vote module implements stake-weighted quadratic voting for confirming external chain events, managing poll lifecycle from creation through threshold completion or expiry."
---
...
type VoteRouter interface {
    ...
    Handler(module string) (exported.VoteHandler, bool)
}
```
