---
title: "EVM Transaction Commands for Axelar Core CLI"
sidebarTitle: "EVM Transactions"
description: "Submit EVM-module transactions with axelard: add chains, set gateways, deploy tokens, confirm events, sign commands, and rotate operatorship."
---
