...
description: "Start axelard, sync via genesis or state sync, monitor health and metrics, manage snapshots, and handle operational tasks like rollback and pruning."
---
